...
parser.add_argument('--resize_freq', default=10, type=int,
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #         'train_acc1': train_metrics.get("train_accuracy", train_metrics.get("train_acc1", 0)),
        #         'train_acc5': train_metrics.get("train_acc5", 0),
        #         'val_loss': val_loss,
        #         'val_acc1': val_acc1,
        #         'val_acc5': val_acc5,
        #         'best_acc1': best_acc1,
        ...
        #         'grad_diversity': round(train_metrics.get("grad_diversity", 0), 4) if args.algorithm == 'divebatch' else None
        #     })
        # scheduler.step()
        log_metrics(
            log_file=log_file,
